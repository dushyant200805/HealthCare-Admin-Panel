            ...
            >
              <thead>
                <tr>
                  ...
                  <td className="text-capitalize text-dark">Name</td>
                  <td className="text-capitalize text-dark">
                    Consulting Doctor
                  </td>
                  <td className="text-capitalize text-dark">Treatment</td>
                  <td className="text-capitalize text-dark">Mobile</td>
                  <td className="text-capitalize text-dark">Email</td>
                  <td className="text-capitalize text-dark">Date</td>
                  <td className="text-capitalize text-dark">Time</td>
                ...
                {data.map((item, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td>{item.time}</td>
                      <td>
                        <Link to="/editappointment" className="btn">
