...
function EditAppointmentPage() {
    ...
    if ($("#edt_appointment").length > 0) {
      $("#edt_appointment").validate({
        ...
        messages: {
          ...
          consultingdoctor: "Please select a doctor",
          treatment: "Please enter treatment details",
        },
        errorElement: "small",
  ...
  return (
    <>
      <PageTitle title="HC-ERP-Edit Appointment" />
      <div className="px-4 mb-4 min-vh-100 outer-main">
        ...
        <div className="d-flex flex-wrap justify-content-between align-items-center my-3">
          <div className="d-flex flex-wrap text-capitalize align-items-center">
            ...
            <i className="bi bi-chevron-right pagination-arrow text-dark-primary"></i>
            <p className="mb-0 pb-0 text-dark">Edit Appointment</p>
          </div>
          <Link
            to="/appointmentlist"
                ...
                <div className="row">
                  ...
                  <div className="col-12 px-3 mb-3">
                    ...
                    <textarea
                      ...
                      cols="30"
                      rows="5"
                      defaultValue="Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae ab voluptatum saepe quae reiciendis esse adipisci iusto atque. Architecto nihil, neque quod unde aliquid, nobis porro in."
                  ...
                  <div className="col-sm-6 px-3 mb-3">
                    ...
                    >
                      ...
                      <option value="Symbol">Symond</option>
                    </select>
                  </div>
                  <div className="col-sm-6 px-3 mb-3">
                    <label
                  ...
                  <div className="col-sm-6 px-3 mb-3">
                    <label htmlFor="notes" className="mb-2 text-dark fw-600">
                      Notes
                    </label>
                    <textarea
                      name="notes"
