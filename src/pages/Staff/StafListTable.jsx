...
const StafListTable = () => {
  ...
  return (
                     ...
                     <table ref={tableRef}  id="stafflisttd"  className="table custom-data-table " style={{ width: "100%" }} >
                       <thead>
                            <tr>
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="d-flex">
                                                <img src={item.StafImage} alt="" width="25" height="25" className="rounded-circle"/>
                                        ...
                                        <td>
                                        <a href="#" className="btn" data-bs-toggle="modal" data-bs-target="#editstaff"><i
