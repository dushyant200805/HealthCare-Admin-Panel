...
function AddDoctorFormPage () {
  ...
  useEffect(() => {
    ...
    return (
        <>
         <PageTitle title="HC-ERP-Add Doctor"/>
     <div className="px-4 mb-4 min-vh-100 outer-main">
        <h3 className="fw-600 text-dark-primary text-capitalize">Add doctor</h3>
        <div className="d-flex flex-wrap justify-content-between align-items-center my-3">
          <div className="d-flex flex-wrap text-capitalize align-items-center">
            ...
            <i className="bi bi-chevron-right pagination-arrow text-dark-primary"></i>
            <p className="mb-0 pb-0 text-dark">Add doctor</p>
          </div>
            ...
            <form id="add_doctor" ref={formRef}>
              <div className="row">
                <div className="col-sm-6 col-lg-4 mb-2">
                  ...
                  <input type="text" name="fname" id="fname" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3">
                  <label htmlFor="lname" className="text-dark-primary mb-2">Last Name<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" name="lname" id="lname" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2">
                  <label htmlFor="username" className="text-dark-primary mb-2">User Name<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" name="username" id="username" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3">
                  <label htmlFor="mobile" className="text-dark-primary mb-2">Mobile Number<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="mobile" name="mobile" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2">
                  <label htmlFor="email" className="text-dark-primary mb-2">Email<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="email" name="email" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2 custom-err">
                  <label htmlFor="pass" className="text-dark-primary mb-2">Password<sup><span
                        className="required">*</span></sup></label>
                  <input type="password" id="pass" name="pass" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2 custom-err">
                  <label htmlFor="repeatpass" className="text-dark-primary mb-2">Confirm Password<sup><span
                        className="required">*</span></sup></label>
                  <input type="password" id="repeatpass" name="repeatpass" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3">
                  <label htmlFor="education" className="text-dark-primary mb-2">Education<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="education" name="education" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2">
                  <label htmlFor="designation" className="text-dark-primary mb-2">Designation<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="designation" name="designation" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2">
                  <label htmlFor="department" className="text-dark-primary mb-2">Department<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="department" name="department" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3">
                  <label htmlFor="city" className="text-dark-primary mb-2">City<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="city" name="city" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-2">
                ...
                <div className="col-sm-6 col-lg-4 mb-3">
                  <label htmlFor="postalcode" className="text-dark-primary mb-2">Postal Code<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" id="postalcode" name="pincode" className="border form-control rounded"/>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3">
                  <label htmlFor="dob" className="text-dark-primary mb-2">Date Of Birth<sup><span
                        className="required">*</span></sup></label>
                  <input type="text" name="dob" id="dob" className="border form-control rounded"/>
                </div>
                ...
                <div className="text-end">
                  <input type="reset" data-bs-dismiss="modal" aria-label="Close"
                    className="btn btn-outline-dark me-3 mw-120 rounded-pill py-2" defaultValue="Cancel"/>
                  <input type="submit" className="btn btn-primary mw-120 rounded-pill py-2" defaultValue="Save"/>
                </div>
              </div>
            </form>
          </div>
...
export default AddDoctorFormPage