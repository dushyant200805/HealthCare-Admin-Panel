        ...
        <div className="col-lg-6">
            <div className="row align-items-center h-100 justify-content-center py-3 py-lg-0">
                <div className="bg-white p-4 shadow  rounded-10 col-sm-10 col-xxl-8 auth-form ">
                    ...
                    <span className="text-gray">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi officia nam
                        repellat magni iusto labore.</span>
                    ...
                    <form className="registervalidate">
                        <div className="mb-3">
                            <label htmlFor="fullname" className="text-dark mb-2">Full name <sup><span
                                        className="required">*</span></sup></label>
                            <input type="text" id="fullname" name="fullname" className="border form-control rounded"/>
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            <label htmlFor="password" className="text-dark mb-2">Password<sup><span
                                        className="required">*</span></sup></label>
                            <input type="text" id="password" name="password" className="border form-control rounded"/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="cnfpass" className="text-dark mb-2">Confirm Password<sup><span
                                        className="required">*</span></sup></label>
                            <input type="text" id="cnfpass" name="cnfpass" className="border form-control rounded"/>
                        </div>
                        <div className="mb-3 d-flex ">
                            <input type="checkbox" className="form-check me-3" name="checkterms" defaultChecked/>
                            <span>I Agree to the <a href="#"
                                    className="text-primary text-decoration-underline fw-600">Terms & Conditions</a> and <a
                                    href="#"
                                    className="text-primary text-decoration-underline fw-600">Privacy Policy</a> </span>
                        </div>
                        <div className="text-center mb-3">
                            <button type="submit"
                                className="btn btn-primary w-75 mw-120 rounded-pill py-2">Register</button>
                        </div>
                    </form>
                    <div className="mb-3 text-center">
                        Already have an Account <Link to="/login"
                            className="text-primary text-decoration-underline fw-600">Login</Link>
                    </div>
                </div>
            </div>
        </div>
