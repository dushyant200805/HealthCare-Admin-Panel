          ...
          <div className="col-sm-6 col-xxl-3 px-4 py-2" key={index}>
            <div className="row align-items-center flex-row-reverse bg-white shadow-sm p-3 h-100  rounded-10">
              ...
              <div className="col-7">
                ...
                <h3 className="text-primary mb-2 fw-bold lh-sm">
                  {item.count}
                </h3>
                <div className="text-nowrap">
                  <span className={`fs-12 ${item.percentageClass}  fw-500`}>
                    <i className={`${item.icon} mx-1`}></i>
                    {item.percentage}
                  </span>
                  <span className="px-1 fs-12 fw-medium text-slate">
                    {item.trend}
                  </span>
                </div>
              </div>
