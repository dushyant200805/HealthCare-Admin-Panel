...
function ComponentPage() {
    return (
        ...
        <div className="bg-white rounded-10 my-3 p-4">
          <h5 className="fw-600 text-dark-primary text-capitalize mt-0 mb-4">Color Codes</h5>
          <div className="row">
            <BackgorundColor/>
          </div>
        </div>
        <div className="bg-white  rounded-10 my-3 p-4">
          <h5 className="fw-600 text-dark-primary text-capitalize mt-0 mb-4">Buttons UI</h5>
        ...
        <div className="bg-white rounded-10 my-3 p-4">
          <div className="social-icons mb-4 border p-3 rounded">
            <h5 className="fw-600 text-dark-primary text-capitalize mt-0 mb-4">Social Icons</h5>
             <div className="d-flex flex-wrap gap-2">
              <SocialCard/>
             </div>
          </div>
          <div className="badges border p-3 mb-4 rounded">
            <h5 className="fw-600 text-dark-primary text-capitalize mt-0 mb-4">Badges</h5>
            <div className="my-3">
               <BageCard1/>
            </div>
            <div className="my-3">
          ...
          <div className="alert&toast border p-3 mb-4 rounded">
            <h5 className="fw-600 text-dark-primary text-capitalize mt-0 mb-4">Alerts & Toasts</h5>
            <div className="d-flex gap-2 align-items-center">
              <button className="btn btn-danger rounded-pill" data-bs-toggle="modal"
                data-bs-target="#deleteconf">Delete</button>
              <button className="btn btn-success rounded-pill px-3" data-bs-toggle="modal"
                data-bs-target="#success">Add</button>
              <div>
                <button type="button" className="btn btn-primary mw-120 rounded-pill" id="liveToastBtn">Toast Btn</button>
          ...
          <div className="links border p-3 rounded">
            <p className="m-0 mb-2">We have used icons of <Link to="https://icons.getbootstrap.com/"
                className="text-decoration-underline">Bootstrap icons</Link> & <Link to="https://fontawesome.com/icons"
                className="text-decoration-underline"> Font Awesome 6</Link></p>
            <p className="m-0 mb-2">You can access all images from images folder which is located at "public" in
              the root of the folder.</p>
          </div>
        </div>
      </div>
      <DeleteModal/>
