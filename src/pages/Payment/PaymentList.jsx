...
function PaymentList() {
    ...
    return (
      ...
      <div className="px-4 mb-4 min-vh-100 outer-main">
        <h3 className="fw-600 text-dark-primary text-capitalize">Payment List</h3>
        <div className="d-flex flex-wrap justify-content-between align-items-center my-3">
          ...
          <Link to="#" className="btn btn-primary rounded-4 fw-500 py-2 rounded-pill mw-120 px-4 text-capitalize"
            data-bs-toggle="modal" data-bs-target="#addbill"><i className="bi bi-plus-circle me-2"></i> add new Payment</Link>
        </div>
                ...
                {data.map((item,index)=>{
                    return (
                        <tr key={item.id}>
                            ...
                            <td>
                            <span className={`custom-badge badge ${item.statusclass} text-white align-items-center rounded-pill text-capitalize`}>{item.status}</span>
                            </td>
                            <td>{item.date}</td>
                            <td>{item.tax}</td>
                            <td>{item.discount}</td>
                            <td>{item.total}</td>
                            <td>
                            <a href="#" className="btn" data-bs-toggle="modal" data-bs-target="#editbill"><i
